...
//    POWER_OF_MANY (Category.ARMOR_ABILITY, null, 17),
    PROGRESSIVE_WEAPON (Category.WEAPONRY, null, 0),
    PROGRESSIVE_ARMOR (Category.WEAPONRY, null, 1),
    PROGRESSIVE_MISSILE (Category.WEAPONRY, null, 2),
    ...
    ARCANE_STYLUS (Category.MISC, null, 0),
    TORCHES (Category.MISC, null, 3),
    WATERSKIN (Category.MISC, null, 2),
    ...
    BLACKSMITH_QUEST (Category.QUEST, null, 2),
    AMBITIOUS_IMP_QUEST (Category.QUEST, null, 3),
