...
public enum APItem {
    ...
    * 1150-1339 talents
    * 1340-1349 progressive level ups
    *
    ******************* WEAPONRY 1350-1449 *******************
    ...
    */
    ...
    WARRIOR (Category.CHARACTER, null, null, 0, 1100),
    ...
    PROVOKED_ANGER (Category.TALENT, null, null, 2, 1152),
    ...
    EXPANDING_WAVE (Category.TALENT, null, null, 20, 1170),
    ...
    INSCRIBED_STEALTH (Category.TALENT, null, null, 47, 1207),
    ...
    ADVENTURERS_INTUITION (Category.TALENT, null, null, 95, 1255),
    ...
    WARRIOR_PROGRESSIVE_MAX_LEVEL (Category.LEVEL, Subcategory.WARRIOR, null, 0, 1340),
    MAGE_PROGRESSIVE_MAX_LEVEL (Category.LEVEL, Subcategory.MAGE, null, 1, 1341),
    ROGUE_PROGRESSIVE_MAX_LEVEL (Category.LEVEL, Subcategory.ROGUE, null, 2, 1342),
    HUNTRESS_PROGRESSIVE_MAX_LEVEL (Category.LEVEL, Subcategory.HUNTRESS, null, 3, 1343),
    DUELIST_PROGRESSIVE_MAX_LEVEL (Category.LEVEL, Subcategory.DUELIST, null, 4, 1344),
    CLERIC_PROGRESSIVE_MAX_LEVEL (Category.LEVEL, Subcategory.CLERIC, null, 5, 1345),
