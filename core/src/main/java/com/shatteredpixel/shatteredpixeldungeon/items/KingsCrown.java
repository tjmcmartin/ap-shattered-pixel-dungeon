...
public class KingsCrown extends Item {
	...
	public ArrayList<String> actions( Hero hero ) {
		...
		if (APManager.hasArmorAbilities(hero)) actions.add( AC_WEAR );
		return actions;
	}
	...
	@Override
	public String desc() {
		if ((ShatteredPixelDungeon.scene() instanceof GameScene || ShatteredPixelDungeon.scene() instanceof AlchemyScene) && !APManager.hasArmorAbilities(Dungeon.hero)) {
			return Messages.get(this, "desc_no_abilities");
		} else {
			return super.desc();
		}
	}
