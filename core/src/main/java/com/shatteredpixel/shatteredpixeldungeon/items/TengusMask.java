...
public class TengusMask extends Item {
	...
	public ArrayList<String> actions( Hero hero ) {
		...
		if (APManager.hasSubclasses(hero)) actions.add( AC_WEAR );
		return actions;
	}
	...
	@Override
	public String desc() {
		if ((ShatteredPixelDungeon.scene() instanceof GameScene || ShatteredPixelDungeon.scene() instanceof AlchemyScene) && !APManager.hasSubclasses(Dungeon.hero)) {
			return Messages.get(this, "desc_no_subclasses");
		} else {
			return super.desc();
		}
	}
